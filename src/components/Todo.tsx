...
export default function Todo({ data }: TodoProps) {
  ...
  return (
    <Reorder.Item value={data} id={data._id} style={{ y }}>
      <div className=" p-3 rounded-lg shadow-sm  border-2 border-gray-400 my-2">
        <div className="flex justify-between">
          ...
          <div>
            {editMode ? (
              ...
              <>
                <button onClick={() => setEditMode(true)} className="0 ms-2">
                  수정
                </button>
          ...
          {editMode ? (
            ...
            <span
              className={`text-xs px-2 py-1 ${
                (data.label.id === "67b9a48f67b4270871740d0b" &&
                  "bg-red-200") ||
                (data.label.id === "67b9a48f67b4270871740d0c" &&
                  "bg-sky-200") ||
                (data.label.id === "67b9a48f67b4270871740d0d" &&
                  "bg-green-200") ||
                (data.label.id == "67b9a48f67b4270871740d0e" &&
                  "bg-yellow-200") ||
                (data.label.id === "67b9a48f67b4270871740d0f" &&
                  "bg-indigo-200")
              } rounded-md`}
            >
              {data.label.title}
